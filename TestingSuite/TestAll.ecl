...
action6 := OUTPUT(Utils.GenerateCode('Classification.TestLogisticRegression',  classificationDatasetNamesD, BenchmarkResults.logistic_regression_performance_scores, c_no_of_elementsD, repeat_no), NAMED('Classification_LogisticRegression'));
